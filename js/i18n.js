...
export const TRANSLATIONS = {
    es: {
        ...
        'admin.supervisors.new.title': 'Nuevo Inspector de Calidad',
        'admin.supervisors.edit.title': 'Editar Inspector de Calidad',
        'admin.supervisors.save.new': 'Guardar Inspector de Calidad',
        'admin.supervisors.save.update': 'Actualizar Inspector de Calidad',
        'admin.supervisors.role.fallback': 'Inspector de Calidad',
        'admin.supervisors.stat.active': 'Inspectores de Calidad activos',
        'admin.supervisors.empty': 'No hay inspectores que coincidan con el filtro actual.',
        'admin.supervisors.email.placeholder': 'inspector@worktrace.com',
        'admin.supervisors.status.activating': 'Activando inspector...',
        'admin.supervisors.status.deactivating': 'Desactivando inspector...',
        'admin.supervisors.status.activated': 'Inspector activado correctamente.',
        'admin.supervisors.status.deactivated': 'Inspector desactivado correctamente.',
        'admin.supervisors.status.error': 'No fue posible actualizar el estado del inspector.',
        'admin.supervision.monitor.filter.label': 'Inspector de Calidad',
    ...
    en: {
        ...
        'admin.supervisors.new.title': 'New Quality Inspector',
        'admin.supervisors.edit.title': 'Edit Quality Inspector',
        'admin.supervisors.save.new': 'Save Quality Inspector',
        'admin.supervisors.save.update': 'Update Quality Inspector',
        'admin.supervisors.role.fallback': 'Quality Inspector',
        'admin.supervisors.stat.active': 'Active Quality Inspectors',
        'admin.supervisors.empty': 'No inspectors match the current filter.',
        'admin.supervisors.email.placeholder': 'inspector@worktrace.com',
        'admin.supervisors.status.activating': 'Activating inspector...',
        'admin.supervisors.status.deactivating': 'Deactivating inspector...',
        'admin.supervisors.status.activated': 'Inspector activated successfully.',
        'admin.supervisors.status.deactivated': 'Inspector deactivated successfully.',
        'admin.supervisors.status.error': 'Could not update the inspector status.',
        'admin.supervision.monitor.filter.label': 'Quality Inspector',
